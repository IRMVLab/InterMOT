...
class Kitti2DBox(_BaseDataset):
    ...
    def get_default_dataset_config():
        ...
        default_config = {
            'GT_FOLDER': os.path.join(code_path, '../data/tracking'),  # Location of GT data
            'TRACKERS_FOLDER': os.path.join(code_path, '../experiments/rrc_pfv_40e_subabs_dualadd_C/results/19998'),  # Trackers location
