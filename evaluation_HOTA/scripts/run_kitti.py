...
def eval_kitti(t_sha, root = None, part="val", gt_path="./data/tracking"):
    freeze_support()
    ...
    if root is not None:
        default_dataset_config['GT_FOLDER'] = gt_path
        default_dataset_config['TRACKERS_FOLDER'] = os.path.join(root, t_sha)
        default_dataset_config['SPLIT_TO_EVAL'] = part
